 ...
 *    - Créez en plus une méthode statique permettant de mettre à jour la propriété statique du nombre total d'abonnés
 * sur TOUTES les plateformes. ( addAbo() ou je ne sais quoi )
 ...
 *
 * 5. Invoquez la méthode vous permettant de récupérer le nombre total d'abonnements aux plateformes VOD de manière
 *    à afficher le nombre total d'abonnements.
 */
...
echo " Il y a au total : ". VOD::getTotalNumbersSubscribes()." abonnés";
